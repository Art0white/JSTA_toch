...
public class QiniuUtil {
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "Y-mIY15oVv314_ja7fqZOd859gTf_C5iacJCBZeA";
    private static final String SECRET_KEY = "rkgROJCGHcj7qDjKkR1C5a7ACczk_-WXpW_WtR-l";

    // 要上传的空间
    private static final String bucketname = "security-tmall";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "r76ab0jr2.hb-bkt.clouddn.com";
